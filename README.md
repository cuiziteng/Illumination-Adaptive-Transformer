...
<span style="color:red;">Illumination</span> <font color=green>Adaptive</font> <font color=blue>Transformer</font> for Vision Tasks on both **Human Vision** and **Machine Vision**
