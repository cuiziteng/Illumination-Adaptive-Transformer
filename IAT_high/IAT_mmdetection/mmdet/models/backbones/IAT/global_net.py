...
class Global_pred(nn.Module):
    def __init__(self, in_channels=3, out_channels=64, num_heads=4):
        ...
        self.gamma_base = nn.Parameter(torch.ones((1)), requires_grad=False)  # basic gamma value
        self.color_base = nn.Parameter(torch.eye((3)), requires_grad=False)  # basic color matrix
        # main blocks
